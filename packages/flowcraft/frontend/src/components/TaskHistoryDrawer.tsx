...
export const TaskHistoryDrawer: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[400px] bg-background border-t border-border z-[2000] flex flex-col shadow-2xl animate-in slide-in-from-bottom duration-300">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-[320px] border-r border-border flex flex-col bg-muted/10">
          ...
          {selectedTask ? (
            <div className="flex flex-col h-full">
                ...
                <div className="flex gap-2">
                  {selectedTask.nodeId && (
                    <Button
                      ...
                      variant="outline"
                    >
                      <RotateCw size={12} /> Restart Instance
                    </Button>
                  )}
                  {(selectedTask.status === TaskStatus.TASK_PROCESSING ||
              ...
              <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-64 bg-muted/5 p-4 flex flex-col gap-4">
                  <section>
                  ...
                  <div className="mt-auto p-3 rounded border border-border bg-background flex flex-col gap-2">
                    <div className="flex items-center gap-2 text-[10px] font-bold">
                      <History size={12} />
                      <span>STATE_SNAPSHOT</span>
                    </div>
                    <p className="text-[10px] text-muted-foreground leading-relaxed">
                      Instance status currently tracking through ephemeral
                      memory. Persistent storage synced:{" "}
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground p-12">
              ...
              <p className="text-sm font-medium">
                Select an instance to inspect lifecycle
              </p>
              <p className="text-xs opacity-50 mt-1">
                Real-time kernel activity will appear here
              </p>
            </div>
          )}
        </div>

...
export const flowcraft = ($root.flowcraft = (() => {
  ...
  flowcraft.v1 = (function () {
    ...
    v1.ActionTemplate = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ActionTemplate.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
      ...
      ActionTemplate.decode = function decode(reader, length, error) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ActionTemplate();
      ...
      ActionTemplate.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.ActionTemplate) return object;
        ...
        if (object.path) {
          if (!Array.isArray(object.path))
            throw TypeError(
              ".flowcraft.v1.ActionTemplate.path: array expected",
            );
          message.path = [];
      ...
      ActionTemplate.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          object.label = "";
          object.strategy =
            options.enums === String ? "EXECUTION_IMMEDIATE" : 0;
          object.description = "";
          object.icon = "";
        }
        if (message.id != null && message.hasOwnProperty("id"))
        ...
        if (message.strategy != null && message.hasOwnProperty("strategy"))
          object.strategy =
            options.enums === String
              ? $root.flowcraft.v1.ActionExecutionStrategy[message.strategy] ===
                undefined
                ? message.strategy
                : $root.flowcraft.v1.ActionExecutionStrategy[message.strategy]
              : message.strategy;
    ...
    v1.ActionDiscoveryRequest = (function () {
        ...
        if (message.selectedNodeIds != null && message.selectedNodeIds.length)
          for (let i = 0; i < message.selectedNodeIds.length; ++i)
            writer
              ...
              .string(message.selectedNodeIds[i]);
        return writer;
      };
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ActionDiscoveryRequest.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      ActionDiscoveryRequest.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ActionDiscoveryRequest();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      ActionDiscoveryRequest.decodeDelimited = function decodeDelimited(
        reader,
      ) {
        if (!(reader instanceof $Reader)) reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
      ...
      ActionDiscoveryRequest.verify = function verify(message) {
        ...
        if (
          message.selectedNodeIds != null &&
          message.hasOwnProperty("selectedNodeIds")
        ) {
      ...
      ActionDiscoveryRequest.fromObject = function fromObject(object) {
        ...
        if (object.selectedNodeIds) {
          if (!Array.isArray(object.selectedNodeIds))
            throw TypeError(
              ".flowcraft.v1.ActionDiscoveryRequest.selectedNodeIds: array expected",
            );
          message.selectedNodeIds = [];
      ...
      ActionDiscoveryRequest.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.selectedNodeIds = [];
        if (options.defaults) object.nodeId = "";
        if (message.nodeId != null && message.hasOwnProperty("nodeId"))
    ...
    v1.ActionDiscoveryResponse = (function () {
      ...
      ActionDiscoveryResponse.encode = function encode(message, writer) {
        ...
        if (message.actions != null && message.actions.length)
          for (let i = 0; i < message.actions.length; ++i)
            $root.flowcraft.v1.ActionTemplate.encode(
              message.actions[i],
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ActionDiscoveryResponse.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      ActionDiscoveryResponse.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ActionDiscoveryResponse();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              ...
              message.actions.push(
                $root.flowcraft.v1.ActionTemplate.decode(
                  reader,
                  reader.uint32(),
                ),
              );
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      ActionDiscoveryResponse.decodeDelimited = function decodeDelimited(
        reader,
      ) {
        if (!(reader instanceof $Reader)) reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
      ...
      ActionDiscoveryResponse.verify = function verify(message) {
        ...
        if (message.actions != null && message.hasOwnProperty("actions")) {
          if (!Array.isArray(message.actions)) return "actions: array expected";
          for (let i = 0; i < message.actions.length; ++i) {
            let error = $root.flowcraft.v1.ActionTemplate.verify(
              message.actions[i],
            );
      ...
      ActionDiscoveryResponse.fromObject = function fromObject(object) {
        ...
        if (object.actions) {
          if (!Array.isArray(object.actions))
            throw TypeError(
              ".flowcraft.v1.ActionDiscoveryResponse.actions: array expected",
            );
          message.actions = [];
          for (let i = 0; i < object.actions.length; ++i) {
            if (typeof object.actions[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.ActionDiscoveryResponse.actions: object expected",
              );
            message.actions[i] = $root.flowcraft.v1.ActionTemplate.fromObject(
              object.actions[i],
            );
          }
        }
      ...
      ActionDiscoveryResponse.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.actions = [];
        if (message.actions && message.actions.length) {
          object.actions = [];
          for (let j = 0; j < message.actions.length; ++j)
            object.actions[j] = $root.flowcraft.v1.ActionTemplate.toObject(
              message.actions[j],
              options,
            );
        }
    ...
    v1.ActionExecutionRequest = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ActionExecutionRequest.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      ActionExecutionRequest.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ActionExecutionRequest();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      ActionExecutionRequest.decodeDelimited = function decodeDelimited(
        reader,
      ) {
        if (!(reader instanceof $Reader)) reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
      ...
      ActionExecutionRequest.verify = function verify(message) {
        ...
        if (
          message.sourceNodeId != null &&
          message.hasOwnProperty("sourceNodeId")
        )
          if (!$util.isString(message.sourceNodeId))
            return "sourceNodeId: string expected";
        if (
          message.contextNodeIds != null &&
          message.hasOwnProperty("contextNodeIds")
        ) {
      ...
      ActionExecutionRequest.fromObject = function fromObject(object) {
        ...
        if (object.contextNodeIds) {
          if (!Array.isArray(object.contextNodeIds))
            throw TypeError(
              ".flowcraft.v1.ActionExecutionRequest.contextNodeIds: array expected",
            );
          message.contextNodeIds = [];
      ...
      ActionExecutionRequest.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.contextNodeIds = [];
        if (options.defaults) {
          object.actionId = "";
          object.sourceNodeId = "";
          object.paramsJson = "";
    ...
    v1.ActionExecutionResult = (function () {
      ...
      ActionExecutionResult.encode = function encode(message, writer) {
        ...
        if (message.diff != null && Object.hasOwnProperty.call(message, "diff"))
          $root.flowcraft.v1.GraphDiff.encode(
            message.diff,
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ActionExecutionResult.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      ActionExecutionResult.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ActionExecutionResult();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            ...
            case 3: {
              message.diff = $root.flowcraft.v1.GraphDiff.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      ActionExecutionResult.fromObject = function fromObject(object) {
        ...
        if (object.diff != null) {
          if (typeof object.diff !== "object")
            throw TypeError(
              ".flowcraft.v1.ActionExecutionResult.diff: object expected",
            );
      ...
      ActionExecutionResult.toObject = function toObject(message, options) {
        ...
        if (message.diff != null && message.hasOwnProperty("diff"))
          object.diff = $root.flowcraft.v1.GraphDiff.toObject(
            message.diff,
            options,
          );
        if (message.strategy != null && message.hasOwnProperty("strategy"))
    ...
    v1.GraphDiff = (function () {
      ...
      GraphDiff.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.nodesJson != null &&
          Object.hasOwnProperty.call(message, "nodesJson")
        )
          writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.nodesJson);
        if (
          message.edgesJson != null &&
          Object.hasOwnProperty.call(message, "edgesJson")
        )
        ...
        if (message.removeNodeIds != null && message.removeNodeIds.length)
          for (let i = 0; i < message.removeNodeIds.length; ++i)
            writer
              .uint32(/* id 3, wireType 2 =*/ 26)
              .string(message.removeNodeIds[i]);
        if (message.removeEdgeIds != null && message.removeEdgeIds.length)
          for (let i = 0; i < message.removeEdgeIds.length; ++i)
            writer
              ...
              .string(message.removeEdgeIds[i]);
        return writer;
      };
      ...
      GraphDiff.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.GraphDiff();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      GraphDiff.verify = function verify(message) {
        ...
        if (
          message.removeNodeIds != null &&
          message.hasOwnProperty("removeNodeIds")
        ) {
        ...
        if (
          message.removeEdgeIds != null &&
          message.hasOwnProperty("removeEdgeIds")
        ) {
      ...
      GraphDiff.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.GraphDiff) return object;
        ...
        if (object.removeNodeIds) {
          if (!Array.isArray(object.removeNodeIds))
            throw TypeError(
              ".flowcraft.v1.GraphDiff.removeNodeIds: array expected",
            );
          message.removeNodeIds = [];
        ...
        if (object.removeEdgeIds) {
          if (!Array.isArray(object.removeEdgeIds))
            throw TypeError(
              ".flowcraft.v1.GraphDiff.removeEdgeIds: array expected",
            );
          message.removeEdgeIds = [];
    ...
    v1.Position = (function () {
      ...
      Position.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Position();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      Position.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Position) return object;
    ...
    v1.Rect = (function () {
      ...
      Rect.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Rect();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      Rect.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Rect) return object;
    ...
    v1.Viewport = (function () {
      ...
      Viewport.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Viewport();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      Viewport.verify = function verify(message) {
        ...
        if (message.zoom != null && message.hasOwnProperty("zoom"))
          if (typeof message.zoom !== "number") return "zoom: number expected";
        return null;
      };
      ...
      Viewport.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Viewport) return object;
        let message = new $root.flowcraft.v1.Viewport();
        if (object.x != null) message.x = Number(object.x);
        if (object.y != null) message.y = Number(object.y);
        if (object.zoom != null) message.zoom = Number(object.zoom);
        return message;
      };
      ...
      Viewport.toObject = function toObject(message, options) {
        ...
        if (message.zoom != null && message.hasOwnProperty("zoom"))
          object.zoom =
            options.json && !isFinite(message.zoom)
              ? String(message.zoom)
              : message.zoom;
        return object;
      };
    ...
    v1.PortType = (function () {
      ...
      PortType.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.mainType != null &&
          Object.hasOwnProperty.call(message, "mainType")
        )
        ...
        if (
          message.isGeneric != null &&
          Object.hasOwnProperty.call(message, "isGeneric")
        )
      ...
      PortType.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.PortType();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      PortType.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.PortType) return object;
        let message = new $root.flowcraft.v1.PortType();
        if (object.mainType != null) message.mainType = String(object.mainType);
    ...
    v1.Port = (function () {
      ...
      Port.encode = function encode(message, writer) {
        ...
        if (message.type != null && Object.hasOwnProperty.call(message, "type"))
          $root.flowcraft.v1.PortType.encode(
            message.type,
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
          ).ldelim();
        if (
          message.style != null &&
          Object.hasOwnProperty.call(message, "style")
        )
      ...
      Port.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Port();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            ...
            case 3: {
              message.type = $root.flowcraft.v1.PortType.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      Port.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Port) return object;
      ...
      Port.toObject = function toObject(message, options) {
        ...
        if (message.label != null && message.hasOwnProperty("label"))
          object.label = message.label;
        if (message.type != null && message.hasOwnProperty("type"))
          object.type = $root.flowcraft.v1.PortType.toObject(
            message.type,
            options,
          );
        if (message.style != null && message.hasOwnProperty("style"))
          object.style =
            options.enums === String
              ? $root.flowcraft.v1.PortStyle[message.style] === undefined
                ? message.style
                : $root.flowcraft.v1.PortStyle[message.style]
              : message.style;
        if (message.color != null && message.hasOwnProperty("color"))
    ...
    v1.Edge = (function () {
      ...
      Edge.encode = function encode(message, writer) {
        ...
        if (
          message.sourceHandle != null &&
          Object.hasOwnProperty.call(message, "sourceHandle")
        )
          writer
            .uint32(/* id 4, wireType 2 =*/ 34)
            .string(message.sourceHandle);
        if (
          message.targetHandle != null &&
          Object.hasOwnProperty.call(message, "targetHandle")
        )
          writer
            .uint32(/* id 5, wireType 2 =*/ 42)
            .string(message.targetHandle);
        if (
      ...
      Edge.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Edge(),
          key,
          value;
        while (reader.pos < end) {
          let tag = reader.uint32();
      ...
      Edge.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Edge) return object;
        ...
        if (object.metadata) {
          ...
          message.metadata = {};
          for (
            let keys = Object.keys(object.metadata), i = 0;
            i < keys.length;
            ++i
          )
      ...
      Edge.toObject = function toObject(message, options) {
        ...
        if (
          message.metadata &&
          (keys2 = Object.keys(message.metadata)).length
        ) {
          object.metadata = {};
    ...
    v1.FlowMessage = (function () {
       ...
       * @instance
       */
      FlowMessage.prototype.timestamp = $util.Long
      ...
      /**
       * FlowMessage payload.
       * @member {"syncRequest"|"nodeUpdate"|"widgetUpdate"|"actionExecute"|"taskCancel"|"viewportUpdate"|"snapshot"|"mutations"|"taskUpdate"|"streamChunk"|"error"|undefined} payload
       * @memberof flowcraft.v1.FlowMessage
       * @instance
       */
      ...
      FlowMessage.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "syncRequest")
        )
          $root.flowcraft.v1.SyncRequest.encode(
            message.syncRequest,
            writer.uint32(/* id 10, wireType 2 =*/ 82).fork(),
          ).ldelim();
        if (
          message.nodeUpdate != null &&
          Object.hasOwnProperty.call(message, "nodeUpdate")
        )
          $root.flowcraft.v1.UpdateNodeRequest.encode(
            message.nodeUpdate,
            writer.uint32(/* id 11, wireType 2 =*/ 90).fork(),
          ).ldelim();
        if (
          message.widgetUpdate != null &&
          Object.hasOwnProperty.call(message, "widgetUpdate")
        )
          $root.flowcraft.v1.UpdateWidgetRequest.encode(
            message.widgetUpdate,
            writer.uint32(/* id 12, wireType 2 =*/ 98).fork(),
          ).ldelim();
        if (
          message.actionExecute != null &&
          Object.hasOwnProperty.call(message, "actionExecute")
        )
          $root.flowcraft.v1.ActionExecutionRequest.encode(
            message.actionExecute,
            writer.uint32(/* id 13, wireType 2 =*/ 106).fork(),
          ).ldelim();
        if (
          message.taskCancel != null &&
          Object.hasOwnProperty.call(message, "taskCancel")
        )
          $root.flowcraft.v1.TaskCancelRequest.encode(
            message.taskCancel,
            writer.uint32(/* id 14, wireType 2 =*/ 114).fork(),
          ).ldelim();
        if (
          message.viewportUpdate != null &&
          Object.hasOwnProperty.call(message, "viewportUpdate")
        )
          $root.flowcraft.v1.ViewportUpdate.encode(
        ...
        if (
          ...
          $root.flowcraft.v1.GraphSnapshot.encode(
            message.snapshot,
            writer.uint32(/* id 20, wireType 2 =*/ 162).fork(),
          ).ldelim();
        if (
          message.mutations != null &&
          Object.hasOwnProperty.call(message, "mutations")
        )
          $root.flowcraft.v1.MutationList.encode(
            message.mutations,
            writer.uint32(/* id 21, wireType 2 =*/ 170).fork(),
          ).ldelim();
        if (
          message.taskUpdate != null &&
          Object.hasOwnProperty.call(message, "taskUpdate")
        )
          $root.flowcraft.v1.TaskUpdate.encode(
            message.taskUpdate,
            writer.uint32(/* id 22, wireType 2 =*/ 178).fork(),
          ).ldelim();
        if (
          message.streamChunk != null &&
          Object.hasOwnProperty.call(message, "streamChunk")
        )
          $root.flowcraft.v1.StreamChunk.encode(
            message.streamChunk,
        ...
        if (
          ...
          $root.flowcraft.v1.ErrorResponse.encode(
            message.error,
      ...
      FlowMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.FlowMessage();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            ...
            case 10: {
              message.syncRequest = $root.flowcraft.v1.SyncRequest.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 11: {
              message.nodeUpdate = $root.flowcraft.v1.UpdateNodeRequest.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 12: {
              message.widgetUpdate =
                $root.flowcraft.v1.UpdateWidgetRequest.decode(
                  reader,
                  reader.uint32(),
                );
              break;
            ...
            case 13: {
              message.actionExecute =
                $root.flowcraft.v1.ActionExecutionRequest.decode(
                  reader,
                  reader.uint32(),
                );
              break;
            ...
            case 14: {
              message.taskCancel = $root.flowcraft.v1.TaskCancelRequest.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 15: {
              message.viewportUpdate = $root.flowcraft.v1.ViewportUpdate.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 20: {
              message.snapshot = $root.flowcraft.v1.GraphSnapshot.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 21: {
              message.mutations = $root.flowcraft.v1.MutationList.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 22: {
              message.taskUpdate = $root.flowcraft.v1.TaskUpdate.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 23: {
              message.streamChunk = $root.flowcraft.v1.StreamChunk.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 24: {
              message.error = $root.flowcraft.v1.ErrorResponse.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      FlowMessage.verify = function verify(message) {
        ...
        if (
          message.syncRequest != null &&
          message.hasOwnProperty("syncRequest")
        ) {
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.SyncRequest.verify(
              message.syncRequest,
            );
            if (error) return "syncRequest." + error;
          }
        }
        if (
          message.nodeUpdate != null &&
          message.hasOwnProperty("nodeUpdate")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.UpdateNodeRequest.verify(
              message.nodeUpdate,
            );
            if (error) return "nodeUpdate." + error;
          }
        }
        if (
          message.widgetUpdate != null &&
          message.hasOwnProperty("widgetUpdate")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.UpdateWidgetRequest.verify(
              message.widgetUpdate,
            );
            if (error) return "widgetUpdate." + error;
          }
        }
        if (
          message.actionExecute != null &&
          message.hasOwnProperty("actionExecute")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.ActionExecutionRequest.verify(
              message.actionExecute,
            );
            if (error) return "actionExecute." + error;
          }
        }
        if (
          message.taskCancel != null &&
          message.hasOwnProperty("taskCancel")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.TaskCancelRequest.verify(
              message.taskCancel,
            );
            if (error) return "taskCancel." + error;
          }
        }
        if (
          message.viewportUpdate != null &&
          message.hasOwnProperty("viewportUpdate")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.ViewportUpdate.verify(
              message.viewportUpdate,
            );
            if (error) return "viewportUpdate." + error;
          }
        }
        if (message.snapshot != null && message.hasOwnProperty("snapshot")) {
          ...
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.GraphSnapshot.verify(
              message.snapshot,
            );
        ...
        if (message.mutations != null && message.hasOwnProperty("mutations")) {
          ...
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.MutationList.verify(
              message.mutations,
            );
        ...
        if (
          message.taskUpdate != null &&
          message.hasOwnProperty("taskUpdate")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.TaskUpdate.verify(
              message.taskUpdate,
            );
            if (error) return "taskUpdate." + error;
          }
        }
        if (
          message.streamChunk != null &&
          message.hasOwnProperty("streamChunk")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            let error = $root.flowcraft.v1.StreamChunk.verify(
              message.streamChunk,
            );
            if (error) return "streamChunk." + error;
          }
        }
      ...
      FlowMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.FlowMessage) return object;
        ...
        if (object.syncRequest != null) {
          if (typeof object.syncRequest !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.syncRequest: object expected",
            );
          message.syncRequest = $root.flowcraft.v1.SyncRequest.fromObject(
            object.syncRequest,
          );
        }
        if (object.nodeUpdate != null) {
          if (typeof object.nodeUpdate !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.nodeUpdate: object expected",
            );
          message.nodeUpdate = $root.flowcraft.v1.UpdateNodeRequest.fromObject(
            object.nodeUpdate,
          );
        }
        if (object.widgetUpdate != null) {
          if (typeof object.widgetUpdate !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.widgetUpdate: object expected",
            );
          message.widgetUpdate =
            $root.flowcraft.v1.UpdateWidgetRequest.fromObject(
              object.widgetUpdate,
            );
        }
        if (object.actionExecute != null) {
          if (typeof object.actionExecute !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.actionExecute: object expected",
            );
          message.actionExecute =
            $root.flowcraft.v1.ActionExecutionRequest.fromObject(
        ...
        if (object.taskCancel != null) {
          if (typeof object.taskCancel !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.taskCancel: object expected",
            );
          message.taskCancel = $root.flowcraft.v1.TaskCancelRequest.fromObject(
            object.taskCancel,
          );
        }
        if (object.viewportUpdate != null) {
          if (typeof object.viewportUpdate !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.viewportUpdate: object expected",
            );
          message.viewportUpdate = $root.flowcraft.v1.ViewportUpdate.fromObject(
            object.viewportUpdate,
          );
        }
        if (object.snapshot != null) {
          if (typeof object.snapshot !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.snapshot: object expected",
            );
          message.snapshot = $root.flowcraft.v1.GraphSnapshot.fromObject(
            object.snapshot,
          );
        }
        if (object.mutations != null) {
          if (typeof object.mutations !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.mutations: object expected",
            );
          message.mutations = $root.flowcraft.v1.MutationList.fromObject(
            object.mutations,
          );
        }
        if (object.taskUpdate != null) {
          if (typeof object.taskUpdate !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.taskUpdate: object expected",
            );
          message.taskUpdate = $root.flowcraft.v1.TaskUpdate.fromObject(
            object.taskUpdate,
          );
        }
        if (object.streamChunk != null) {
          if (typeof object.streamChunk !== "object")
            throw TypeError(
              ".flowcraft.v1.FlowMessage.streamChunk: object expected",
            );
          message.streamChunk = $root.flowcraft.v1.StreamChunk.fromObject(
            object.streamChunk,
          );
        }
        if (object.error != null) {
          ...
          message.error = $root.flowcraft.v1.ErrorResponse.fromObject(
            object.error,
          );
        }
        return message;
      ...
      FlowMessage.toObject = function toObject(message, options) {
        ...
        if (
          ...
          object.syncRequest = $root.flowcraft.v1.SyncRequest.toObject(
            message.syncRequest,
            options,
          );
          if (options.oneofs) object.payload = "syncRequest";
        }
        if (
          message.nodeUpdate != null &&
          message.hasOwnProperty("nodeUpdate")
        ) {
          object.nodeUpdate = $root.flowcraft.v1.UpdateNodeRequest.toObject(
            message.nodeUpdate,
            options,
          );
          if (options.oneofs) object.payload = "nodeUpdate";
        }
        if (
          message.widgetUpdate != null &&
          message.hasOwnProperty("widgetUpdate")
        ) {
          object.widgetUpdate = $root.flowcraft.v1.UpdateWidgetRequest.toObject(
            message.widgetUpdate,
            options,
          );
          if (options.oneofs) object.payload = "widgetUpdate";
        }
        if (
          message.actionExecute != null &&
          message.hasOwnProperty("actionExecute")
          ...
          object.actionExecute =
            $root.flowcraft.v1.ActionExecutionRequest.toObject(
              message.actionExecute,
              options,
            );
          if (options.oneofs) object.payload = "actionExecute";
        }
        if (
          message.taskCancel != null &&
          message.hasOwnProperty("taskCancel")
        ) {
          object.taskCancel = $root.flowcraft.v1.TaskCancelRequest.toObject(
            message.taskCancel,
            options,
          );
          if (options.oneofs) object.payload = "taskCancel";
        }
        if (
          message.viewportUpdate != null &&
          message.hasOwnProperty("viewportUpdate")
        ) {
          object.viewportUpdate = $root.flowcraft.v1.ViewportUpdate.toObject(
            message.viewportUpdate,
            options,
          );
          if (options.oneofs) object.payload = "viewportUpdate";
        }
        if (message.snapshot != null && message.hasOwnProperty("snapshot")) {
          object.snapshot = $root.flowcraft.v1.GraphSnapshot.toObject(
            message.snapshot,
            options,
          );
        ...
        if (message.mutations != null && message.hasOwnProperty("mutations")) {
          object.mutations = $root.flowcraft.v1.MutationList.toObject(
            message.mutations,
            options,
          );
          if (options.oneofs) object.payload = "mutations";
        }
        if (
          message.taskUpdate != null &&
          message.hasOwnProperty("taskUpdate")
        ) {
          object.taskUpdate = $root.flowcraft.v1.TaskUpdate.toObject(
            message.taskUpdate,
            options,
          );
          if (options.oneofs) object.payload = "taskUpdate";
        }
        if (
          message.streamChunk != null &&
          message.hasOwnProperty("streamChunk")
        ) {
          object.streamChunk = $root.flowcraft.v1.StreamChunk.toObject(
            message.streamChunk,
            options,
          );
          if (options.oneofs) object.payload = "streamChunk";
        }
        if (message.error != null && message.hasOwnProperty("error")) {
          object.error = $root.flowcraft.v1.ErrorResponse.toObject(
            message.error,
            options,
          );
    ...
    v1.SyncRequest = (function () {
      ...
      SyncRequest.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.graphId != null &&
          Object.hasOwnProperty.call(message, "graphId")
        )
      ...
      SyncRequest.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.SyncRequest();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      SyncRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.SyncRequest) return object;
        let message = new $root.flowcraft.v1.SyncRequest();
        if (object.graphId != null) message.graphId = String(object.graphId);
        return message;
      };
      ...
      SyncRequest.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.graphId = "";
        if (message.graphId != null && message.hasOwnProperty("graphId"))
    ...
    v1.UpdateNodeRequest = (function () {
      ...
      UpdateNodeRequest.encode = function encode(message, writer) {
        ...
        if (message.data != null && Object.hasOwnProperty.call(message, "data"))
          $root.flowcraft.v1.NodeData.encode(
            message.data,
        ...
        if (
          ...
          $root.flowcraft.v1.Position.encode(
            message.position,
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
          ).ldelim();
        return writer;
       ...
       * @returns {$protobuf.Writer} Writer
       */
      UpdateNodeRequest.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      UpdateNodeRequest.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.UpdateNodeRequest();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            ...
            case 2: {
              message.data = $root.flowcraft.v1.NodeData.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 3: {
              message.position = $root.flowcraft.v1.Position.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      UpdateNodeRequest.fromObject = function fromObject(object) {
        ...
        if (object.data != null) {
          if (typeof object.data !== "object")
            throw TypeError(
              ".flowcraft.v1.UpdateNodeRequest.data: object expected",
            );
        ...
        if (object.position != null) {
          if (typeof object.position !== "object")
            throw TypeError(
              ".flowcraft.v1.UpdateNodeRequest.position: object expected",
            );
          message.position = $root.flowcraft.v1.Position.fromObject(
            object.position,
          );
        }
        return message;
      ...
      UpdateNodeRequest.toObject = function toObject(message, options) {
        ...
        if (message.nodeId != null && message.hasOwnProperty("nodeId"))
          object.nodeId = message.nodeId;
        if (message.data != null && message.hasOwnProperty("data"))
          object.data = $root.flowcraft.v1.NodeData.toObject(
            message.data,
            options,
          );
        if (message.position != null && message.hasOwnProperty("position"))
          object.position = $root.flowcraft.v1.Position.toObject(
            message.position,
            options,
          );
        return object;
    ...
    v1.UpdateWidgetRequest = (function () {
      ...
      UpdateWidgetRequest.encode = function encode(message, writer) {
        ...
        if (
          ...
          writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.nodeId);
        if (
          message.widgetId != null &&
          Object.hasOwnProperty.call(message, "widgetId")
        )
          writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.widgetId);
        if (
          message.valueJson != null &&
          Object.hasOwnProperty.call(message, "valueJson")
        )
       ...
       * @returns {$protobuf.Writer} Writer
       */
      UpdateWidgetRequest.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      UpdateWidgetRequest.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.UpdateWidgetRequest();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      UpdateWidgetRequest.fromObject = function fromObject(object) {
        ...
        if (object.nodeId != null) message.nodeId = String(object.nodeId);
        if (object.widgetId != null) message.widgetId = String(object.widgetId);
    ...
    v1.ViewportUpdate = (function () {
      ...
      ViewportUpdate.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "viewport")
        )
          $root.flowcraft.v1.Viewport.encode(
            message.viewport,
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
          ).ldelim();
        if (
          message.visibleBounds != null &&
          Object.hasOwnProperty.call(message, "visibleBounds")
        )
          $root.flowcraft.v1.Rect.encode(
            message.visibleBounds,
            writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
          ).ldelim();
        return writer;
      };
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ViewportUpdate.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      ViewportUpdate.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ViewportUpdate();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              message.viewport = $root.flowcraft.v1.Viewport.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 2: {
              message.visibleBounds = $root.flowcraft.v1.Rect.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      ViewportUpdate.verify = function verify(message) {
        ...
        if (message.viewport != null && message.hasOwnProperty("viewport")) {
          ...
          if (error) return "viewport." + error;
        }
        if (
          message.visibleBounds != null &&
          message.hasOwnProperty("visibleBounds")
        ) {
          let error = $root.flowcraft.v1.Rect.verify(message.visibleBounds);
          if (error) return "visibleBounds." + error;
        }
        return null;
      };
      ...
      ViewportUpdate.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.ViewportUpdate) return object;
        let message = new $root.flowcraft.v1.ViewportUpdate();
        if (object.viewport != null) {
          if (typeof object.viewport !== "object")
            throw TypeError(
              ".flowcraft.v1.ViewportUpdate.viewport: object expected",
            );
          message.viewport = $root.flowcraft.v1.Viewport.fromObject(
            object.viewport,
          );
        }
        if (object.visibleBounds != null) {
          if (typeof object.visibleBounds !== "object")
            throw TypeError(
              ".flowcraft.v1.ViewportUpdate.visibleBounds: object expected",
            );
          message.visibleBounds = $root.flowcraft.v1.Rect.fromObject(
      ...
      ViewportUpdate.toObject = function toObject(message, options) {
        ...
        if (message.viewport != null && message.hasOwnProperty("viewport"))
          object.viewport = $root.flowcraft.v1.Viewport.toObject(
            message.viewport,
            options,
          );
        if (
          ...
          object.visibleBounds = $root.flowcraft.v1.Rect.toObject(
            message.visibleBounds,
            options,
          );
        return object;
    ...
    v1.MutationList = (function () {
       ...
       * @instance
       */
      MutationList.prototype.sequenceNumber = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
      ...
      MutationList.encode = function encode(message, writer) {
        ...
        if (message.mutations != null && message.mutations.length)
          for (let i = 0; i < message.mutations.length; ++i)
            $root.flowcraft.v1.GraphMutation.encode(
              message.mutations[i],
              writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
            ).ldelim();
        if (
      ...
      MutationList.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.MutationList();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              ...
              message.mutations.push(
                $root.flowcraft.v1.GraphMutation.decode(
                  reader,
                  reader.uint32(),
                ),
              );
      ...
      MutationList.verify = function verify(message) {
        ...
        if (message.mutations != null && message.hasOwnProperty("mutations")) {
          ...
          for (let i = 0; i < message.mutations.length; ++i) {
            let error = $root.flowcraft.v1.GraphMutation.verify(
              message.mutations[i],
            );
            if (error) return "mutations." + error;
          }
      ...
      MutationList.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.MutationList) return object;
        let message = new $root.flowcraft.v1.MutationList();
        if (object.mutations) {
          if (!Array.isArray(object.mutations))
            throw TypeError(
              ".flowcraft.v1.MutationList.mutations: array expected",
            );
          message.mutations = [];
          for (let i = 0; i < object.mutations.length; ++i) {
            if (typeof object.mutations[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.MutationList.mutations: object expected",
              );
            message.mutations[i] = $root.flowcraft.v1.GraphMutation.fromObject(
              object.mutations[i],
            );
          }
        }
      ...
      MutationList.toObject = function toObject(message, options) {
        ...
        if (message.mutations && message.mutations.length) {
          ...
          for (let j = 0; j < message.mutations.length; ++j)
            object.mutations[j] = $root.flowcraft.v1.GraphMutation.toObject(
              message.mutations[j],
              options,
            );
        }
    ...
    v1.StreamChunk = (function () {
      ...
      StreamChunk.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "chunkData")
        )
          writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.chunkData);
        if (
          message.isDone != null &&
          Object.hasOwnProperty.call(message, "isDone")
        )
      ...
      StreamChunk.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.StreamChunk();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      StreamChunk.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.StreamChunk) return object;
        let message = new $root.flowcraft.v1.StreamChunk();
        if (object.nodeId != null) message.nodeId = String(object.nodeId);
        if (object.widgetId != null) message.widgetId = String(object.widgetId);
        if (object.chunkData != null)
          message.chunkData = String(object.chunkData);
        if (object.isDone != null) message.isDone = Boolean(object.isDone);
        return message;
      };
    ...
    v1.ErrorResponse = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ErrorResponse.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      ErrorResponse.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ErrorResponse();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      ErrorResponse.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.ErrorResponse) return object;
    ...
    v1.FlowService = (function () {
      ...
      (FlowService.prototype = Object.create(
       ...
       */
      FlowService.create = function create(
        rpcImpl,
        requestDelimited,
        responseDelimited,
      ) {
      ...
      Object.defineProperty(
        (FlowService.prototype.connect = function connect(request, callback) {
          return this.rpcCall(
            connect,
            $root.flowcraft.v1.FlowMessage,
            $root.flowcraft.v1.FlowMessage,
            request,
            callback,
          );
    ...
    v1.GraphSnapshot = (function () {
       ...
       * @instance
       */
      GraphSnapshot.prototype.version = $util.Long
        ? $util.Long.fromBits(0, 0, false)
        : 0;
       ...
       * @returns {$protobuf.Writer} Writer
       */
      GraphSnapshot.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      GraphSnapshot.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.GraphSnapshot();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              ...
              message.nodes.push(
                $root.flowcraft.v1.Node.decode(reader, reader.uint32()),
              );
              break;
            }
            case 2: {
              ...
              message.edges.push(
                $root.flowcraft.v1.Edge.decode(reader, reader.uint32()),
              );
              break;
            }
            case 3: {
      ...
      GraphSnapshot.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.GraphSnapshot) return object;
        let message = new $root.flowcraft.v1.GraphSnapshot();
        if (object.nodes) {
          if (!Array.isArray(object.nodes))
            throw TypeError(
              ".flowcraft.v1.GraphSnapshot.nodes: array expected",
            );
          message.nodes = [];
          for (let i = 0; i < object.nodes.length; ++i) {
            if (typeof object.nodes[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.GraphSnapshot.nodes: object expected",
              );
            message.nodes[i] = $root.flowcraft.v1.Node.fromObject(
              object.nodes[i],
            );
          }
        }
        if (object.edges) {
          if (!Array.isArray(object.edges))
            throw TypeError(
              ".flowcraft.v1.GraphSnapshot.edges: array expected",
            );
          message.edges = [];
          for (let i = 0; i < object.edges.length; ++i) {
            if (typeof object.edges[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.GraphSnapshot.edges: object expected",
              );
            message.edges[i] = $root.flowcraft.v1.Edge.fromObject(
              object.edges[i],
            );
          }
        }
      ...
      GraphSnapshot.toObject = function toObject(message, options) {
        ...
        if (message.nodes && message.nodes.length) {
          ...
          for (let j = 0; j < message.nodes.length; ++j)
            object.nodes[j] = $root.flowcraft.v1.Node.toObject(
              message.nodes[j],
              options,
            );
        }
        if (message.edges && message.edges.length) {
          ...
          for (let j = 0; j < message.edges.length; ++j)
            object.edges[j] = $root.flowcraft.v1.Edge.toObject(
              message.edges[j],
              options,
            );
        }
    ...
    v1.GraphMutation = (function () {
      ...
      GraphMutation.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.addNode != null &&
          Object.hasOwnProperty.call(message, "addNode")
        )
          $root.flowcraft.v1.AddNode.encode(
            message.addNode,
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
          ).ldelim();
        if (
          message.updateNode != null &&
          Object.hasOwnProperty.call(message, "updateNode")
        )
          $root.flowcraft.v1.UpdateNode.encode(
            message.updateNode,
            writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
          ).ldelim();
        if (
          message.removeNode != null &&
          Object.hasOwnProperty.call(message, "removeNode")
        )
          $root.flowcraft.v1.RemoveNode.encode(
            message.removeNode,
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
          ).ldelim();
        if (
          message.addEdge != null &&
          Object.hasOwnProperty.call(message, "addEdge")
        )
          $root.flowcraft.v1.AddEdge.encode(
            message.addEdge,
            writer.uint32(/* id 4, wireType 2 =*/ 34).fork(),
          ).ldelim();
        if (
          message.removeEdge != null &&
          Object.hasOwnProperty.call(message, "removeEdge")
        )
          $root.flowcraft.v1.RemoveEdge.encode(
            message.removeEdge,
            writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
          ).ldelim();
        if (
          message.addSubgraph != null &&
          Object.hasOwnProperty.call(message, "addSubgraph")
        )
          $root.flowcraft.v1.AddSubGraph.encode(
            message.addSubgraph,
            writer.uint32(/* id 6, wireType 2 =*/ 50).fork(),
          ).ldelim();
        if (
          message.clearGraph != null &&
          Object.hasOwnProperty.call(message, "clearGraph")
        )
          $root.flowcraft.v1.ClearGraph.encode(
            message.clearGraph,
       ...
       * @returns {$protobuf.Writer} Writer
       */
      GraphMutation.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      GraphMutation.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.GraphMutation();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              message.addNode = $root.flowcraft.v1.AddNode.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 2: {
              message.updateNode = $root.flowcraft.v1.UpdateNode.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 3: {
              message.removeNode = $root.flowcraft.v1.RemoveNode.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 4: {
              message.addEdge = $root.flowcraft.v1.AddEdge.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 5: {
              message.removeEdge = $root.flowcraft.v1.RemoveEdge.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 6: {
              message.addSubgraph = $root.flowcraft.v1.AddSubGraph.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 7: {
              message.clearGraph = $root.flowcraft.v1.ClearGraph.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      GraphMutation.verify = function verify(message) {
        ...
        if (message.addNode != null && message.hasOwnProperty("addNode")) {
          properties.operation = 1;
          {
            ...
            if (error) return "addNode." + error;
          }
        }
        if (
          message.updateNode != null &&
          message.hasOwnProperty("updateNode")
        ) {
          if (properties.operation === 1) return "operation: multiple values";
          properties.operation = 1;
          {
            let error = $root.flowcraft.v1.UpdateNode.verify(
              message.updateNode,
            );
            if (error) return "updateNode." + error;
          }
        }
        if (
          message.removeNode != null &&
          message.hasOwnProperty("removeNode")
        ) {
          if (properties.operation === 1) return "operation: multiple values";
          properties.operation = 1;
          {
            let error = $root.flowcraft.v1.RemoveNode.verify(
              message.removeNode,
            );
            if (error) return "removeNode." + error;
          }
        }
        if (message.addEdge != null && message.hasOwnProperty("addEdge")) {
          ...
          properties.operation = 1;
          {
            ...
            if (error) return "addEdge." + error;
          }
        }
        if (
          message.removeEdge != null &&
          message.hasOwnProperty("removeEdge")
        ) {
          if (properties.operation === 1) return "operation: multiple values";
          properties.operation = 1;
          {
            let error = $root.flowcraft.v1.RemoveEdge.verify(
              message.removeEdge,
            );
            if (error) return "removeEdge." + error;
          }
        }
        if (
          message.addSubgraph != null &&
          message.hasOwnProperty("addSubgraph")
        ) {
          if (properties.operation === 1) return "operation: multiple values";
          properties.operation = 1;
          {
            let error = $root.flowcraft.v1.AddSubGraph.verify(
              message.addSubgraph,
            );
            if (error) return "addSubgraph." + error;
          }
        }
        if (
          message.clearGraph != null &&
          message.hasOwnProperty("clearGraph")
        ) {
          if (properties.operation === 1) return "operation: multiple values";
          properties.operation = 1;
          {
            let error = $root.flowcraft.v1.ClearGraph.verify(
              message.clearGraph,
            );
            if (error) return "clearGraph." + error;
          }
        }
        return null;
      };
      ...
      GraphMutation.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.GraphMutation) return object;
        let message = new $root.flowcraft.v1.GraphMutation();
        if (object.addNode != null) {
          if (typeof object.addNode !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.addNode: object expected",
            );
          message.addNode = $root.flowcraft.v1.AddNode.fromObject(
            object.addNode,
          );
        }
        if (object.updateNode != null) {
          if (typeof object.updateNode !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.updateNode: object expected",
            );
          message.updateNode = $root.flowcraft.v1.UpdateNode.fromObject(
            object.updateNode,
          );
        }
        if (object.removeNode != null) {
          if (typeof object.removeNode !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.removeNode: object expected",
            );
          message.removeNode = $root.flowcraft.v1.RemoveNode.fromObject(
            object.removeNode,
          );
        }
        if (object.addEdge != null) {
          if (typeof object.addEdge !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.addEdge: object expected",
            );
          message.addEdge = $root.flowcraft.v1.AddEdge.fromObject(
            object.addEdge,
          );
        }
        if (object.removeEdge != null) {
          if (typeof object.removeEdge !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.removeEdge: object expected",
            );
          message.removeEdge = $root.flowcraft.v1.RemoveEdge.fromObject(
            object.removeEdge,
          );
        }
        if (object.addSubgraph != null) {
          if (typeof object.addSubgraph !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.addSubgraph: object expected",
            );
          message.addSubgraph = $root.flowcraft.v1.AddSubGraph.fromObject(
            object.addSubgraph,
          );
        }
        if (object.clearGraph != null) {
          if (typeof object.clearGraph !== "object")
            throw TypeError(
              ".flowcraft.v1.GraphMutation.clearGraph: object expected",
            );
          message.clearGraph = $root.flowcraft.v1.ClearGraph.fromObject(
            object.clearGraph,
          );
        }
        return message;
      ...
      GraphMutation.toObject = function toObject(message, options) {
        ...
        let object = {};
        if (message.addNode != null && message.hasOwnProperty("addNode")) {
          object.addNode = $root.flowcraft.v1.AddNode.toObject(
            message.addNode,
            options,
          );
          if (options.oneofs) object.operation = "addNode";
        }
        if (
          message.updateNode != null &&
          message.hasOwnProperty("updateNode")
        ) {
          object.updateNode = $root.flowcraft.v1.UpdateNode.toObject(
            message.updateNode,
            options,
          );
          if (options.oneofs) object.operation = "updateNode";
        }
        if (
          message.removeNode != null &&
          message.hasOwnProperty("removeNode")
        ) {
          object.removeNode = $root.flowcraft.v1.RemoveNode.toObject(
            message.removeNode,
            options,
          );
          if (options.oneofs) object.operation = "removeNode";
        }
        if (message.addEdge != null && message.hasOwnProperty("addEdge")) {
          object.addEdge = $root.flowcraft.v1.AddEdge.toObject(
            message.addEdge,
            options,
          );
          if (options.oneofs) object.operation = "addEdge";
        }
        if (
          message.removeEdge != null &&
          message.hasOwnProperty("removeEdge")
        ) {
          object.removeEdge = $root.flowcraft.v1.RemoveEdge.toObject(
            message.removeEdge,
            options,
          );
          if (options.oneofs) object.operation = "removeEdge";
        }
        if (
          message.addSubgraph != null &&
          message.hasOwnProperty("addSubgraph")
        ) {
          object.addSubgraph = $root.flowcraft.v1.AddSubGraph.toObject(
            message.addSubgraph,
            options,
          );
          if (options.oneofs) object.operation = "addSubgraph";
        }
        if (
          message.clearGraph != null &&
          message.hasOwnProperty("clearGraph")
        ) {
          object.clearGraph = $root.flowcraft.v1.ClearGraph.toObject(
            message.clearGraph,
            options,
          );
          if (options.oneofs) object.operation = "clearGraph";
        }
        return object;
      };
    ...
    v1.AddNode = (function () {
      ...
      AddNode.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.AddNode();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              message.node = $root.flowcraft.v1.Node.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      AddNode.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.AddNode) return object;
    ...
    v1.UpdateNode = (function () {
      ...
      UpdateNode.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.UpdateNode();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      UpdateNode.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.UpdateNode) return object;
        ...
        if (object.position != null) {
          if (typeof object.position !== "object")
            throw TypeError(
              ".flowcraft.v1.UpdateNode.position: object expected",
            );
          message.position = $root.flowcraft.v1.Position.fromObject(
            object.position,
          );
    ...
    v1.RemoveNode = (function () {
      ...
      RemoveNode.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.RemoveNode();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      RemoveNode.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.RemoveNode) return object;
    ...
    v1.AddEdge = (function () {
      ...
      AddEdge.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.AddEdge();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              message.edge = $root.flowcraft.v1.Edge.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      AddEdge.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.AddEdge) return object;
      ...
      AddEdge.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.edge = null;
        if (message.edge != null && message.hasOwnProperty("edge"))
    ...
    v1.RemoveEdge = (function () {
      ...
      RemoveEdge.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.RemoveEdge();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      RemoveEdge.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.RemoveEdge) return object;
    ...
    v1.AddSubGraph = (function () {
      ...
      AddSubGraph.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.AddSubGraph();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      AddSubGraph.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.AddSubGraph) return object;
        ...
        if (object.nodes) {
          ...
          for (let i = 0; i < object.nodes.length; ++i) {
            if (typeof object.nodes[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.AddSubGraph.nodes: object expected",
              );
            message.nodes[i] = $root.flowcraft.v1.Node.fromObject(
              object.nodes[i],
            );
        ...
        if (object.edges) {
          ...
          for (let i = 0; i < object.edges.length; ++i) {
            if (typeof object.edges[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.AddSubGraph.edges: object expected",
              );
            message.edges[i] = $root.flowcraft.v1.Edge.fromObject(
              object.edges[i],
            );
    ...
    v1.ClearGraph = (function () {
      ...
      ClearGraph.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.ClearGraph();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      ClearGraph.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.ClearGraph) return object;
    ...
    v1.TaskUpdate = (function () {
      ...
      TaskUpdate.encode = function encode(message, writer) {
        ...
        if (
          message.resultJson != null &&
          Object.hasOwnProperty.call(message, "resultJson")
        )
      ...
      TaskUpdate.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.TaskUpdate();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      TaskUpdate.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.TaskUpdate) return object;
      ...
      TaskUpdate.toObject = function toObject(message, options) {
        ...
        if (message.status != null && message.hasOwnProperty("status"))
          object.status =
            options.enums === String
              ? $root.flowcraft.v1.TaskStatus[message.status] === undefined
                ? message.status
                : $root.flowcraft.v1.TaskStatus[message.status]
              : message.status;
        if (message.progress != null && message.hasOwnProperty("progress"))
          object.progress =
    ...
    v1.TaskCancelRequest = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      TaskCancelRequest.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      TaskCancelRequest.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.TaskCancelRequest();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      TaskCancelRequest.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.taskId = "";
        if (message.taskId != null && message.hasOwnProperty("taskId"))
          object.taskId = message.taskId;
        return object;
      };
    ...
    v1.Node = (function () {
      ...
      Node.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Node();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      Node.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Node) return object;
    ...
    v1.NodeData = (function () {
      ...
      NodeData.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.NodeData(),
          key,
          value;
        while (reader.pos < end) {
          let tag = reader.uint32();
          ...
          switch (tag >>> 3) {
            ...
            case 2: {
              ...
              } else message.availableModes.push(reader.int32());
              break;
            }
            case 3: {
            ...
            case 4: {
              message.media = $root.flowcraft.v1.MediaContent.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 5: {
              ...
              message.widgets.push(
                $root.flowcraft.v1.Widget.decode(reader, reader.uint32()),
              );
              break;
            }
            case 6: {
              if (!(message.inputPorts && message.inputPorts.length))
                message.inputPorts = [];
              message.inputPorts.push(
                $root.flowcraft.v1.Port.decode(reader, reader.uint32()),
              );
              break;
            }
            case 7: {
      ...
      NodeData.verify = function verify(message) {
        ...
        if (message.label != null && message.hasOwnProperty("label"))
          if (!$util.isString(message.label)) return "label: string expected";
        if (
          message.availableModes != null &&
          message.hasOwnProperty("availableModes")
        ) {
        ...
        if (
          message.inputPorts != null &&
          message.hasOwnProperty("inputPorts")
        ) {
          ...
          for (let i = 0; i < message.inputPorts.length; ++i) {
            ...
            if (error) return "inputPorts." + error;
          }
        }
        if (
          message.outputPorts != null &&
          message.hasOwnProperty("outputPorts")
        ) {
          ...
          for (let i = 0; i < message.outputPorts.length; ++i) {
            ...
            if (error) return "outputPorts." + error;
          }
        }
        if (message.metadata != null && message.hasOwnProperty("metadata")) {
          if (!$util.isObject(message.metadata))
      ...
      NodeData.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.NodeData) return object;
        let message = new $root.flowcraft.v1.NodeData();
        if (object.label != null) message.label = String(object.label);
        if (object.availableModes) {
          if (!Array.isArray(object.availableModes))
            throw TypeError(
              ".flowcraft.v1.NodeData.availableModes: array expected",
            );
          message.availableModes = [];
        ...
        if (object.media != null) {
          ...
          message.media = $root.flowcraft.v1.MediaContent.fromObject(
            object.media,
          );
        }
        if (object.widgets) {
          ...
          for (let i = 0; i < object.widgets.length; ++i) {
            if (typeof object.widgets[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.NodeData.widgets: object expected",
              );
            message.widgets[i] = $root.flowcraft.v1.Widget.fromObject(
              object.widgets[i],
            );
          }
        }
        if (object.inputPorts) {
          if (!Array.isArray(object.inputPorts))
            throw TypeError(
              ".flowcraft.v1.NodeData.inputPorts: array expected",
            );
          message.inputPorts = [];
          for (let i = 0; i < object.inputPorts.length; ++i) {
            if (typeof object.inputPorts[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.NodeData.inputPorts: object expected",
              );
            message.inputPorts[i] = $root.flowcraft.v1.Port.fromObject(
              object.inputPorts[i],
            );
          }
        }
        if (object.outputPorts) {
          if (!Array.isArray(object.outputPorts))
            throw TypeError(
              ".flowcraft.v1.NodeData.outputPorts: array expected",
            );
          message.outputPorts = [];
          for (let i = 0; i < object.outputPorts.length; ++i) {
            if (typeof object.outputPorts[i] !== "object")
              throw TypeError(
                ".flowcraft.v1.NodeData.outputPorts: object expected",
              );
            message.outputPorts[i] = $root.flowcraft.v1.Port.fromObject(
              object.outputPorts[i],
            );
          }
        }
        if (object.metadata) {
      ...
      NodeData.toObject = function toObject(message, options) {
        ...
        if (message.availableModes && message.availableModes.length) {
          ...
          for (let j = 0; j < message.availableModes.length; ++j)
            object.availableModes[j] =
              options.enums === String
                ? $root.flowcraft.v1.RenderMode[message.availableModes[j]] ===
                  undefined
                  ? message.availableModes[j]
                  : $root.flowcraft.v1.RenderMode[message.availableModes[j]]
                : message.availableModes[j];
        }
        if (message.activeMode != null && message.hasOwnProperty("activeMode"))
          object.activeMode =
            options.enums === String
              ? $root.flowcraft.v1.RenderMode[message.activeMode] === undefined
                ? message.activeMode
                : $root.flowcraft.v1.RenderMode[message.activeMode]
              : message.activeMode;
        if (message.media != null && message.hasOwnProperty("media"))
          object.media = $root.flowcraft.v1.MediaContent.toObject(
            message.media,
            options,
          );
        if (message.widgets && message.widgets.length) {
          ...
          for (let j = 0; j < message.widgets.length; ++j)
            object.widgets[j] = $root.flowcraft.v1.Widget.toObject(
              message.widgets[j],
              options,
            );
        }
        if (message.inputPorts && message.inputPorts.length) {
          ...
          for (let j = 0; j < message.inputPorts.length; ++j)
            object.inputPorts[j] = $root.flowcraft.v1.Port.toObject(
              message.inputPorts[j],
              options,
            );
        }
        if (message.outputPorts && message.outputPorts.length) {
          ...
          for (let j = 0; j < message.outputPorts.length; ++j)
            object.outputPorts[j] = $root.flowcraft.v1.Port.toObject(
              message.outputPorts[j],
              options,
            );
        }
        let keys2;
    ...
    v1.MediaContent = (function () {
      ...
      MediaContent.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "aspectRatio")
        )
      ...
      MediaContent.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.MediaContent();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      MediaContent.verify = function verify(message) {
        ...
        if (
          message.aspectRatio != null &&
          message.hasOwnProperty("aspectRatio")
        )
          if (typeof message.aspectRatio !== "number")
            return "aspectRatio: number expected";
        if (
          message.galleryUrls != null &&
          message.hasOwnProperty("galleryUrls")
        ) {
      ...
      MediaContent.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.MediaContent) return object;
        ...
        if (object.galleryUrls) {
          if (!Array.isArray(object.galleryUrls))
            throw TypeError(
              ".flowcraft.v1.MediaContent.galleryUrls: array expected",
            );
          message.galleryUrls = [];
      ...
      MediaContent.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.galleryUrls = [];
        if (options.defaults) {
        ...
        if (message.type != null && message.hasOwnProperty("type"))
          object.type =
            options.enums === String
              ? $root.flowcraft.v1.MediaType[message.type] === undefined
                ? message.type
                : $root.flowcraft.v1.MediaType[message.type]
              : message.type;
        if (message.url != null && message.hasOwnProperty("url"))
        ...
        if (
          ...
          object.aspectRatio =
            options.json && !isFinite(message.aspectRatio)
              ? String(message.aspectRatio)
              : message.aspectRatio;
        if (message.galleryUrls && message.galleryUrls.length) {
          object.galleryUrls = [];
    ...
    v1.WidgetOption = (function () {
      ...
      WidgetOption.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.WidgetOption();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      WidgetOption.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.WidgetOption) return object;
    ...
    v1.WidgetConfig = (function () {
      ...
      WidgetConfig.encode = function encode(message, writer) {
        ...
        if (
          message.dynamicOptions != null &&
          Object.hasOwnProperty.call(message, "dynamicOptions")
        )
          writer
            .uint32(/* id 5, wireType 0 =*/ 40)
            .bool(message.dynamicOptions);
        if (
          message.actionTarget != null &&
          Object.hasOwnProperty.call(message, "actionTarget")
        )
          writer
            .uint32(/* id 6, wireType 2 =*/ 50)
            .string(message.actionTarget);
        return writer;
      };
      ...
      WidgetConfig.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.WidgetConfig();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      WidgetConfig.verify = function verify(message) {
        ...
        if (
          message.placeholder != null &&
          message.hasOwnProperty("placeholder")
        )
      ...
      WidgetConfig.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.WidgetConfig) return object;
    ...
    v1.Widget = (function () {
      ...
      Widget.encode = function encode(message, writer) {
        ...
        if (
          ...
          $root.flowcraft.v1.WidgetConfig.encode(
            message.config,
            writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
          ).ldelim();
        if (message.options != null && message.options.length)
          for (let i = 0; i < message.options.length; ++i)
            $root.flowcraft.v1.WidgetOption.encode(
              message.options[i],
              writer.uint32(/* id 6, wireType 2 =*/ 50).fork(),
            ).ldelim();
        if (
          message.isReadonly != null &&
          Object.hasOwnProperty.call(message, "isReadonly")
        )
          writer.uint32(/* id 7, wireType 0 =*/ 56).bool(message.isReadonly);
        if (
          message.isLoading != null &&
          Object.hasOwnProperty.call(message, "isLoading")
        )
          writer.uint32(/* id 8, wireType 0 =*/ 64).bool(message.isLoading);
        if (
          message.inputPortId != null &&
          Object.hasOwnProperty.call(message, "inputPortId")
        )
      ...
      Widget.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.flowcraft.v1.Widget();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            ...
            case 5: {
              message.config = $root.flowcraft.v1.WidgetConfig.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 6: {
              ...
              message.options.push(
                $root.flowcraft.v1.WidgetOption.decode(reader, reader.uint32()),
              );
              break;
            }
            case 7: {
      ...
      Widget.verify = function verify(message) {
        ...
        if (message.options != null && message.hasOwnProperty("options")) {
          ...
          for (let i = 0; i < message.options.length; ++i) {
            let error = $root.flowcraft.v1.WidgetOption.verify(
              message.options[i],
            );
        ...
        if (
          message.inputPortId != null &&
          message.hasOwnProperty("inputPortId")
        )
      ...
      Widget.fromObject = function fromObject(object) {
        if (object instanceof $root.flowcraft.v1.Widget) return object;
        ...
        if (object.config != null) {
          ...
          message.config = $root.flowcraft.v1.WidgetConfig.fromObject(
            object.config,
          );
        }
        if (object.options) {
          ...
          for (let i = 0; i < object.options.length; ++i) {
            ...
            message.options[i] = $root.flowcraft.v1.WidgetOption.fromObject(
              object.options[i],
            );
          }
        }
      ...
      Widget.toObject = function toObject(message, options) {
        ...
        if (message.type != null && message.hasOwnProperty("type"))
          object.type =
            options.enums === String
              ? $root.flowcraft.v1.WidgetType[message.type] === undefined
                ? message.type
                : $root.flowcraft.v1.WidgetType[message.type]
              : message.type;
        if (message.label != null && message.hasOwnProperty("label"))
          object.label = message.label;
        if (message.valueJson != null && message.hasOwnProperty("valueJson"))
          object.valueJson = message.valueJson;
        if (message.config != null && message.hasOwnProperty("config"))
          object.config = $root.flowcraft.v1.WidgetConfig.toObject(
            message.config,
            options,
          );
        if (message.options && message.options.length) {
          ...
          for (let j = 0; j < message.options.length; ++j)
            object.options[j] = $root.flowcraft.v1.WidgetOption.toObject(
              message.options[j],
              options,
            );
        }

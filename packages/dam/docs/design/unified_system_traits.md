...
The format of a `TraitImplementationIdentifier` is a pipe-separated string: `{trait_identifier}|{component_name}`. For example, `asset.operation|ContentMimeTypeComponent`.

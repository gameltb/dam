...
async def create_transcode_profile(
    ...
    async with world.db_session_maker() as session:
        ...
        stmt_existing = select(TranscodeProfileComponent).where(
            TranscodeProfileComponent.profile_name == profile_name
        )
...
async def get_transcoded_variants_for_original(
    ...
    async def _get(db_session: Session):
        stmt = (
            ...
            .join(TranscodeProfileComponent, TranscodedVariantComponent.transcode_profile_entity_id == TranscodeProfileComponent.entity_id)

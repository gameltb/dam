...
from sqlalchemy.orm import Mapped, mapped_column  # Added relationship
...
class Entity(Base):  # Inherit from the new Base
    ...
    # from dataclasses import field as dataclass_field # Removed
    ...
    # components: Mapped[List["BaseComponent"]] = dataclass_field( # Removed
